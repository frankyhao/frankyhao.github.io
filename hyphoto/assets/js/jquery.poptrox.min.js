...
function newFunction() {
    ...
    if (0 == this.length)
        ...
        var i; if (!p && h)
            ...
            } b.trigger("startSpinning").fadeIn(300), x.show(), s.popupIsFixed ? (x.removeClass("loading").width(s.popupWidth).height(s.popupHeight), w.on("load", function() { w.off("load"), b.hide().trigger("stopSpinning"), m.trigger("update", [i.captionText]).fadeIn(s.fadeSpeed), C.fadeIn(s.fadeSpeed), v.css("text-indent", 0).hide().fadeIn(s.fadeSpeed, function() { h = !1; }), d = t, P.fadeIn(s.fadeSpeed); })) : w.on("load", function() { f(), w.off("load"), b.hide().trigger("stopSpinning"); var e = w.width(), o = w.height(), p = function() { m.trigger("update", [i.captionText]).fadeIn(s.fadeSpeed), C.fadeIn(s.fadeSpeed), v.css("text-indent", 0).hide().fadeIn(s.fadeSpeed, function() { h = !1; }), d = t, P.fadeIn(s.fadeSpeed), x.removeClass("loading").data("width", e).data("height", o).css("width", "auto").css("height", "auto"); }; e == x.data("width") && o == x.data("height") ? p() : x.animate({ width: e, height: o }, s.popupSpeed, "swing", p); }), "image" != i.type && w.trigger("load");
        }).on("poptrox_close", function() { return !(!h || s.usePopupForceClose) || (h = !0, x.hide().trigger("poptrox_reset"), s.onPopupClose && s.onPopupClose(), void a.fadeOut(s.fadeSpeed, function() { s.useBodyOverflow && n.css("overflow", "auto"), h = !1; })); }).trigger("poptrox_reset"), s.usePopupEasyClose ? (m.on("click", "a", function(e) { e.stopPropagation(); }), x.css("cursor", "pointer").on("click", function(e) { e.stopPropagation(), e.preventDefault(), x.trigger("poptrox_close"); })) : x.on("click", function(e) { e.stopPropagation(); }), l.keydown(function(e) {
        if (x.is(":visible"))
            switch (e.keyCode) {
                case 37:
                case 32:
        ...
        var t, p, i = e(this), r = i.find("img"), n = i.data("poptrox"); if ("ignore" != n && i.attr("href")) {
            ...
            "file:" == window.location.protocol && t.src.match(/^\/\//) && (t.src = "http:" + t.src), u.push(t), r.removeAttr("title"), i.removeAttr("href").css("cursor", "pointer").css("outline", 0).on("click", function(e) { e.preventDefault(), e.stopPropagation(), x.trigger("poptrox_open", [o]); });
        }
        }), r.prop("_poptrox", s), r;
    };
    } (jQuery);
